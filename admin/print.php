...
@page { margin: 0; }
	...
	?>
		<header>
			<h1>Invoice</h1>
			<address >
				<p>HOTEL MANGEMNET SYSTEM,</p>
				<p>GULSHAN PARK,<br>FAISLABAD,<br>PAKISTAN</p>
				<p>(+92) 303 961 97 93</p>
			</address>
		...
		<aside>
			...
			<div >
				<p align="center">Email :- munirashraf652@gmail.com || Web :- info.hms.com || Phone :- +92 303 961 9793 </p>
			</div>
		</aside>
	</body>
</html>
